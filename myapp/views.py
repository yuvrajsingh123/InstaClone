#('b05a87fc2d9b16a', 'e40bae7fc06026074022bcac6b4f370fe4963cba')
#apikey = 'DRmg2bz8D85xI8Tm0pSCYOITFGx1EyirLk1nhhGduJs'
#app = ClarifaiApp(api_key='e3475406ddda439aa8a077faa6ad201b')
...
def send_mail(url):
    sg = sendgrid.SendGridAPIClient(apikey='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')

    from_email = Email("ysyuvraj079@gmail.com")
    to_email = Email("yuvi0622@gmail.com")
